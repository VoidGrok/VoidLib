...
config.Window = function(title)
    ...
    -- NOVO: Alert com borda (OutlineFrame) - integrado do alert.lua
    config.AlertOutline = function(msg)
        local AlertFrame = Instance.new("ScreenGui")
        AlertFrame.Name = "AlertFrameOutline"
        AlertFrame.Parent = CoreGui
